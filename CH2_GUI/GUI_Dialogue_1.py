...
class MainWindow(QWidget):
    ...
    def pushButton1_Clicked(self):
        ...
        #QInputDialog는 항상 OK와 cancle이 나옴
        #OK 클릭 시, ok=True, cancel클릭 시 ok = False
        print(text, ok)
    ...
    def pushButton2_Clicked(self):
        ...
        item, ok = QInputDialog.getItem(self, "포지션 선택", "포지션을 선택하세요.", items, 0, False) #0을 쓰면 default값이 item의 0번째 index
        if ok and item:
