...
class MainWindow(QWidget):          # QWidget 클래스의 서브클래스
    ...
    def setupUI(self):              # UI를 구성함
        ...
        # self.setGeometry(0, 0, 400, 300)      # x, y, w, h 한번에 설정
        self.move(0, 0)         # x, y
        ...
        self.pushButton.resize(self.pushButton.sizeHint()) #pushButton을 감쌀 수 있는 사이즈로 설정
        self.pushButton.setToolTip("버튼 툴팁") #마우스를 올렸을 때 툴팁
