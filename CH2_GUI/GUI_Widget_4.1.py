...
class MainWindow(QWidget):          # QWidget 클래스의 서브클래스
    ...
    def setupUI(self):
        ...
        self.tableWidget.setEditTriggers(QAbstractItemView.NoEditTriggers) #editTrigger설정 시 클릭 이벤트, noEditTrigger로 설정했음
        self.tableWidget.setHorizontalHeaderLabels(columnNames) #headerlable을 설정
