...
class MainWindow(QWidget):
    ...
    def setupUI(self):
        ...
        # DB 검색문 실행
        query = DB_Queries()
        rows = query.selectPlayerPosition()        # 딕셔너리의 리스트 (5개의 값이 출력)
        print(rows)
        print()
        ...
        self.comboBox.activated.connect(self.comboBox_Activated) #펼치는 것이 activated. 펼쳤을 때 comboBox_Activated를 연결
